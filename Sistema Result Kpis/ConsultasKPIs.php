            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Consultas KPI´s</h1>
                        <a href="ReporteKpis.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Generar informe</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($rol == 1 or 2) { ?>
                                                <a class="btn btn-danger" href="BorrarConsulta.php?Id=<?php echo $row["id"] ?>">Borrar</a>
                                            <?php } ?>
                                        </td>
