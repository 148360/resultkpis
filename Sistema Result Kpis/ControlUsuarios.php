            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="container"> 
                        <h1>Haz clic en una elección</h1>
                        <hr/>
                        <br/>  <br/>  <br/>  <br/>

                           <!-- Agrega una imagen con un link-->
                                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="AgregarUsuarios.php">
                               <!-- <i class="far fa-address-card"></i> -->
                                

                                    <div> <img src="agregar.png"  width="100%" height="100%" > </div>
                                    </div>
                                 <div class="btn btn-info" style="font-size:20px;">Agregar un Usuario</div>
                                 </a>
                                 <br/><br/>
                                   
                            <!-- Agrega una imagen con un link-->
                                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="ConsultasUsuarios.php">
                                    <!--  <div class="sidebar-brand-icon "> -->
                                   <!-- <i class="fas fa-tasks"></i>-->
                                    <div> <img src="gestionar.png"  width="100%" height="100%" > </div>
                                    </div>
                                 <div class="btn btn-info" style="font-size:20px;">Gestionar Usuarios</div>
                                </a>
