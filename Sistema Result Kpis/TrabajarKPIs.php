            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Trabajar con KPI´s</h1>
                        <a href="ReporteTrabajo.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
echo "<td>"; echo $filas ['actividad']; echo "</td>";
...
echo "<td>"; echo  date_format($date, 'Y-m-d'); echo "</td>";
    ...
    //echo "<td>";
    //echo "<input type='checkbox' value='20' name='check1[".$filas["id"]."]' />Concluido";
    //echo "</td>";
...
echo "<td>"; echo  date_format($date, 'Y-m-d'); echo "</td>";
    ...
    //echo "<td>";
    //echo "<input type='checkbox' value='20' name='check2[".$filas["id"]."]' />Concluido";
    //echo "</td>";

echo "<td>"; echo $filas ['tarea1']; echo "</td>";

//echo "<td>";
    //echo "<input type='checkbox' value='' name='check3[".$filas["id"]."]' />Concluido";
    //echo "</td>";

echo "<td>"; echo $filas ['tarea2']; echo "</td>";

//echo "<td>";
    //echo "<input type='checkbox' value='' name='check4[".$filas["id"]."]' />Concluido";
    //echo "</td>";

echo "<td>"; echo $filas ['tarea3']; echo "</td>";
//echo "<td>";
    //echo "<input type='checkbox' value='' name='check5[".$filas["id"]."]' />Concluido";
    //echo "</td>";.
  

    echo "<td>"; echo $filas ['detalles']; echo "</td>";

    
  echo "<td>";
  echo "<a class='btn btn-success' href='Trabajar.php?id={$filas["id"]}'>Trabajar</a>"; 
 ...
 // echo "<td>";
   // echo "<a href='BorrarKPI.php?Id={$filas["id"]}'>Borrar</a>";
//echo "</td>";
