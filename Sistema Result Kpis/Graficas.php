...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://web.facebook.com/Result-KPIs-103498791870952">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Indicador Grafico</h1>
                <!--        <a href="404.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                        <i class="fas fa-download fa-sm text-white-50"></i>Generar informe</a>  -->
                    ...
                    <figure class="highcharts-figure">
                        ...
                        <a class="btn btn-info" href="TrabajarKPIs.php">Regresar a la lista de KPI's</a>
                        

                        
                        <a class="btn btn-success" href="Trabajar.php?id=<?php echo $_GET["id"] ?>">Regresar a Trabajar  </a>
                        ...
                        <!-- <a href='Trabajar.php?id={$filas["id"]}'>Regresar al KPI</a> -->
        ...
        viewData: "Ver Datos de la Tabla",
                            ...
                            title: {
                                text: 'KPI por Usuario y Actividad seleccionada'
                            },
                            tooltip: {
                               ...
                               // name: 'Cumplimiento del',
                                ...
                                data: [
                                    ...
                                    while ($filas = mysqli_fetch_assoc($result)) {
                                        echo "[' Fecha de Inicio: " . $filas["fechadeinicio"] . "'," . $filas["check1"] . ",],";
                                        echo "[' Fecha de Termino: " . $filas["fechadetermino"] ." '," . $filas["check2"] . ",],";
                                        echo "['" . $filas["tarea1"] . "'," . $filas["check3"] . ",],";
                                        echo "['" . $filas["tarea2"] . "'," . $filas["check4"] . ",],";
                                        echo "['" . $filas["tarea3"] . "'," . $filas["check5"] . ",],";
