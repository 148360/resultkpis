  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
        ...
        <li class="nav-item"> <a class="nav-link" href="https://web.facebook.com/Result-KPIs-103498791870952">
        ...
        <li class="nav-item"> <a class="nav-link" href="https://es.wikipedia.org/wiki/Wikipedia:Portada">
            <i class="fas fa-blog"></i> <span>Blog</span></a> </li>
        <!-- Elemento de navegación - Juego -->
        <li class="nav-item"> <a class="nav-link" href="juego.php">
