  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container">
          <h1>Edita los datos del Usuario</h1>
          <hr />

          <?php
          include 'conexion.php';
          //se trae el usuario que se va modificar
          $consulta = "SELECT * FROM usuarios where id={$user_id}";
          $user = mysqli_query($mysqli, $consulta);
          $user = $user->fetch_assoc();
          // print_r($kpi);
          ?>

          <form action="ModificarUsuariosBD.php" method="POST">
            ...
            <input type="text" class="form-control" name="contraseña" value="<?php echo $user["contraseña"] ?>" />
            <br />



            <label for="Descripcion">Descripcion</label>
            <textarea class="form-control" rows="3" name="descripcion"><?php echo $user["descripcion"]?></textarea>
