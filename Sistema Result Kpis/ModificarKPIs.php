...
<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        ...
        <div class="container">
          ...
          //se trae el kpi que se va modificar
          $consulta = "SELECT *,
          (select empresa_id from usuarios where kpi.usuario_id =usuarios.id) empresa_id
          
           FROM kpi where id={$kpi_id}";
          $kpi = mysqli_query($mysqli, $consulta);
          $kpi = $kpi->fetch_assoc();
         // print_r($kpi);
          ?>

          <form action="ModificarKPIsBD.php" method="POST">
<input type="hidden" value= "<?php echo $kpi['id'] ?>" name= "id" >
            ...
            <input type="text" class="form-control" name="area" value="<?php echo $kpi["area"] ?>" />
            <br />
            ...
            <input type="text" class="form-control" name="actividad" value="<?php echo $kpi["actividad"] ?>"/>
            <br />

            <label for="Fecha de Inicio ">Fecha de Inicio</label>
            <input type="date" class="form-control" name="fechadeinicio" value="<?php echo date_format(date_create($kpi['fechadeinicio']), 'Y-m-d') ?>"/>
            <br />
        
            <label for="Fecha de Termino">Fecha de Termino</label>
            <input type="date" class="form-control" name="fechadetermino" value="<?php echo date_format(date_create($kpi['fechadetermino']), 'Y-m-d') ?>"/>
            <br />


            <label for="Tarea 1">Tarea 1</label>
            <input type="text" class="form-control" name="tarea1" value="<?php echo $kpi["tarea1"] ?>" />
            <br />


            <label for="Tarea 2">Tarea 2</label>
            <input type="text" class="form-control" name="tarea2" value="<?php echo $kpi["tarea2"] ?>" />
            <br />


            <label for="Tarea 3">Tarea 3</label>
            <input type="text" class="form-control" name="tarea3" value="<?php echo $kpi["tarea3"] ?>"/>
            <br />


            <label for="Detalles">Detalles</label>
            <textarea class="form-control" rows="3" name="detalles"><?php echo $kpi["detalles"]?></textarea>

            <br />

            <label for="Comentarios">Comentarios</label>
            <textarea class="form-control" rows="3" name="comentarios"><?php echo $kpi["comentarios"]?></textarea>
