  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
        ...
        id="accordionSidebar">
        <!-- Barra lateral: marca --> <a class="sidebar-brand d-flex align-items-center justify-content-center"
        ...
        <div class="sidebar-card"> <img class="sidebar-card-illustration mb-2"
        ...
        <div id="content">
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
              <div class="input-group"> <input class="form-control bg-light border-0 small"
                ...
                <div class="input-group-append"> <button class="btn btn-primary"
                    ...
                    type="button"> <i class="fas fa-search fa-sm"></i> </button>
                </div>
              </div>
            </form>
            ...
            <ul class="navbar-nav ml-auto">
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                      ...
                      <span class="font-weight-bold">¡Un nuevo informe mensual
                        está listo para descargar!</span> </div>
                    ...
                    <div>
                      ...
                      $290.29 ¡Se han depositado $ 290.29 en su cuenta! </div>
                  </a> <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3">
                    ...
                    href="#">Mostrar todas las alertas</a> </div>
              </li>
              <!-- Elemento de navegación - Mensajes -->
              <li class="nav-item dropdown no-arrow mx-1"> <a class="nav-link dropdown-toggle"

                  href="#" id="messagesDropdown" role="button" data-toggle="dropdown"
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div class="dropdown-list-image mr-3"> <img class="rounded-circle"
                        ...
                        src="img/undraw_profile_2.svg" alt="">
              ...
              <li class="nav-item dropdown no-arrow"> <a class="nav-link dropdown-toggle"
                  ...
                  aria-haspopup="true" aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $nombre; ?>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                  ...
                  aria-labelledby="userDropdown"> <a class="dropdown-item" href="#">
          ...
          <div class="container"> 
            <h1>Ingresa los datos del usuario</h1>
            <hr/>


            <form action="AgregarUsuariosBD.php" method="POST">
...
<?php foreach ($ejecutar as $rol):  ?>
<option value="<?php echo $rol ['id']?>" ><?php echo $rol ['tipo']?></option>
<?php endforeach ?>
...
<br/>
            ...
            <!--  <label for="Rol">Rol</label>
              ...
              <label for="Descripcion del Usuario">Descripcion del Usuario</label>
              <textarea class="form-control" rows="3" name="descripcion"></textarea>
              <br/>


            <input type="submit" value="CREAR USUARIO" class="btn btn-success"/>
            <a class="btn btn-info" href="ControlUsuarios.php">Regresar al Panel Control de Usuarios</a>
            </form>
            <br/>
        ...
        <!-- Fin del pie de página --> </div>
      <!-- Envoltorio de fin de contenido --> </div>
    <!-- Contenedor de fin de página -->
    <!-- Desplazarse hasta el botón superior--> <a class="scroll-to-top rounded"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer"> <button class="btn btn-secondary" type="button"
              ...
              data-dismiss="modal">Cancelar</button> <a class="btn btn-primary"

              href="destruye.php">Cerrar sesión</a> </div>
        </div>
      </div>
    </div>
